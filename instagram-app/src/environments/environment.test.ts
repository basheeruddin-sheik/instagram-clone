export const environment = {
    ...
    auth: {
        CLIENT_ID: "0YTDSCcy0b17cJR3FkZQ7Kwq9goYS0KV",
        CLIENT_DOMAIN: "auth.sandbox.medeintegra.dev",
        AUDIENCE: "https://test.medeintegra.dev",
        IAM_EXCHANGE_URL: "https://iam.test.medeintegra.dev/emrstudio/token/exchange",
        CONNECTION: "MEDEX-TEST-DB",
    },
    
    medexIam: {
      url: "https://iam.test.medeintegra.dev",
