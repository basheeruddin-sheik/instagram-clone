export const environment = {
  ...
  auth: {
    CLIENT_ID: "5rp0TysMsHm8mtmGcbpNxD9W6l9SR9dH",
    CLIENT_DOMAIN: "oauth.medeintegra.dev",
    AUDIENCE: "https://medeintegra.dev",
    IAM_EXCHANGE_URL: "https://iam.medeintegra.dev/emrstudio/token/exchange",
    CONNECTION: "MEDEX-PROD",
  },
  
  medexIam: {
    url: "https://iam.medeintegra.dev",
  ...
  medexBlob: {
    url: "https://blob.medeintegra.dev",
    path: {
      upload: "/blob/upload"
    }
  },
